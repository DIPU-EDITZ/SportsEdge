...
function Hero() {
  return (
    <div className="pt-28 pb-20 md:pt-40 md:pb-32 px-6 md:px-12 lg:px-24 max-w-[100rem] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        <div className="w-full max-w-[420px] bg-white/30 backdrop-blur-3xl border border-white/30 rounded-[2.5rem] p-6 md:p-8 shadow-2xl flex flex-col justify-between">
          ...
          <div className="bg-white/30 backdrop-blur-md border border-white/40 rounded-3xl p-5 mt-8 shadow-sm">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                <span className="text-sm">View Product Range</span>
              ...
              >
                <span className="text-sm">Meet Our Clients</span>
