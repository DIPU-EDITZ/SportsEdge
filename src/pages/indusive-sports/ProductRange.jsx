...
const products = [
    ...
    },
    {
        ...
        category: "Synthetic Turf",
        description:
            "FIFA certified synthetic turf systems engineered for maximum player safety, optimal ball bounce, and year-round performance.",
    ...
    },
    {
        ...
        description:
            "ITF certified acrylic court systems designed to reduce joint stress while offering medium-fast paced play and brilliant colors.",
...

    {
        ...
        description:
            "High-performance synthetic surfaces offering excellent grip, shock absorption, and true bounce for all levels of play.",
    ...
    },
    {
        ...
        description:
            "Premium wooden courts designed for professional indoor sports, featuring advanced sub-floor systems for optimal energy return.",
    ...
    },
    {
        ...
        category: "Acrylic Systems",
        description:
            "ITF certified acrylic surfacing for tennis, basketball, and multi-sport use, providing consistent bounce and vibrant aesthetics.",
    ...
    },
    {
        ...
        description:
            "Versatile and durable interlocking PP tiles for outdoor and indoor multi-sport courts, providing easy installation and all-weather use.",
            ...
            <section className="bg-white border-b border-gray-200 pt-32 pb-16 md:pt-40 md:pb-24 px-6 md:px-12 lg:px-24">
                <div className="max-w-7xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 text-lg md:text-xl max-w-3xl mx-auto">
                        Explore our comprehensive portfolio of
                        international-standard sports infrastructure solutions,
                        from synthetic turfs to high-performance acrylic
                        systems.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 px-6 md:px-12 lg:px-24">
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {products.map((product, idx) => (
                        <div
                            key={idx}
                            className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-300 flex flex-col"
                        >
                                    ...
                                    <ul className="space-y-2">
                                        {product.features.map((feat, i) => (
                                            ...
                                            >
                                                <Circle
                                                    size={8}
                                                    className="text-[#84cc16] mr-3 fill-[#84cc16]"
                                                />
                                                {feat}
                                            </li>
                                        ))}
