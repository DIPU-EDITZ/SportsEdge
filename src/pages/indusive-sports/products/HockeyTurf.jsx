...
const stats = [
    {
        ...
        number: "8",
        label: "Years",
        sub: "FIH Certified Manufacturer",
    },
    {
        icon: Globe,
        number: "Top 10",
        label: "Worldwide",
        sub: "FIH Preferred Suppliers",
    },
    {
        icon: ShieldCheck,
        number: "#1",
        label: "In Asia",
        sub: "Only FIH Preferred Supplier",
    },
    {
        icon: Activity,
        number: "Tier 1",
        label: "Certified",
        sub: "Olympic Games & World Cup",
    },
];
...
const fields = [
    ...
    {
        level: "Global",
        desc: "International and top level national competitions",
    },
...
const products = [
    {
        level: "Global",
        desc: 'Non-filled "wet" hockey turf used for international and top level national competitions',
    },
    {
        level: "National",
        desc: "Sand dressed or sand filled turf for high level club/college play",
    },
    {
        level: "Multi-sport",
        desc: "Sand dressed or sand filled synthetic turf or textile surfaces for and on which basic community multi-sport play",
    },
];

const metricsTable = [
    {
        property: "Ball Rebound",
        global: "100mm-400mm",
        national: "100mm-425mm",
    },
    { property: "Ball Roll", global: "≥10m", national: "≥9m" },
    {
        property: "Ball Roll Deviation",
        global: "@9.5m≤0.5m",
        national: "@8.5m≤0.45m",
    },
    { property: "Shock Absorption", global: "45-60%", national: "40-65%" },
    {
        property: "Vertical Deformation",
        global: "4mm-9mm",
        national: "4mm-9mm",
    },
    {
        property: "Shoe/Surface Friction",
        global: "25Nm-45Nm",
        national: "25Nm-45Nm",
    },
];
                ...
                >
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-gray-600 text-lg md:text-xl mb-6 leading-relaxed">
                            We are an FIH Preferred Supplier and FIH Certified
                            Manufacturer for 8 years. The International Hockey
                            Federation (FIH) divides hockey fields into global
                            elite level, global level, national level, and
                            multi-level. We offer systems for all applications
                            from international matches to junior training.
                        </p>
                        <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
                            As an FIH preferred supplier, our hockey systems
                            meet all FIH standards, including but not limited to
                            ball roll, ball rebound, and impact response. Our
                            global level system is certified for FIH Tier 1
                            competitions such as Olympic Games and the World
                            Cup.
                        </p>
                ...
                >
                    ...
                    <div>
                        ...
                        <h2 className="text-3xl font-extrabold text-gray-900 mb-6">
                            Why Choose an FIH Preferred Producer?
                        </h2>
                        <p className="text-gray-600 mb-8 leading-relaxed">
                            FIH Certified Manufacturers are companies that
                            specialise in the manufacturing of hockey turf and
                            provide a one-step shop solution for building hockey
                            fields to the standards the game requires, operate
                            quality management systems to ensure consistency in
                            their products and provide comprehensive maintenance
                            advice.
                        </p>
                        <ul className="space-y-4">
                            {whyChooseUs.map((item, i) => (
                                <li key={i} className="flex items-start gap-3">
                                    <CheckCircle2
                                        size={20}
                                        className="text-[#84cc16] mt-1 shrink-0"
                                    />
                ...
                >
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">
                            FIH Hockey Certified Systems
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Our systems meet all FIH standards. The
                            International Hockey Federation divides hockey
                            fields into various levels to suit different
                            applications.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-8 flex items-center gap-2">
                                <Star className="text-[#84cc16]" /> Certified
                                Fields
                            </h3>
                            <div className="space-y-4">
                                {fields.map((f, i) => (
                                    <div
                                        key={i}
                                        className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col sm:flex-row sm:items-center gap-4 hover:shadow-md transition-shadow"
                                    >
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-gray-900 mb-8 flex items-center gap-2">
                                <Award className="text-[#84cc16]" /> Certified
                                Products
                            </h3>
                            <div className="space-y-4">
                                {products.map((p, i) => (
                                    <div
                                        key={i}
                                        className="bg-white rounded-xl border border-gray-200 p-6 flex flex-col sm:flex-row gap-4 hover:shadow-md transition-shadow"
                                    >
                                        <div className="sm:w-1/3">
                        ...
                        <table className="w-full text-left border-collapse rounded-2xl overflow-hidden shadow-sm">
                            <thead>
                                <tr className="bg-gray-900 text-white">
                                    <th className="py-5 px-6 font-bold uppercase tracking-wider text-sm border-b border-gray-700">
                                        Property
                                    </th>
                                    <th className="py-5 px-6 font-bold uppercase tracking-wider text-sm border-b border-gray-700">
                                        Global
