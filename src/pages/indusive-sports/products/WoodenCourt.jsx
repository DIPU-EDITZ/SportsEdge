...
const stats = [
  { icon: Factory, number: '50+', label: 'Arenas Completed', sub: 'Premium wood' },
  { icon: Globe, number: 'FIBA', label: 'Certified', sub: 'Competition grade' },
  { icon: ShieldCheck, number: '25yr', label: 'Lifespan', sub: 'Highly durable' },
  { icon: Award, number: 'A+', label: 'Grade Wood', sub: 'Canadian Maple / Teak' },
];
...
const layers = [
  {
    ...
    description: 'Top-grade Canadian Maple or Teak wood provides a durable and responsive surface. Finished with specialized anti-skid varnish for professional play.',
  },
  {
    title: 'Sprung Sub-floor',
    subtitle: 'Resilient frame · Shock absorption',
    description: 'A double-layered wooden framework with rubber pads creates a "sprung" floor effect, significantly reducing impact stress on athletes\' bodies.',
  },
  {
    title: 'Vapor Barrier',
    subtitle: 'PE film · Moisture protection',
    description: 'A heavy-duty polyethylene barrier protects the wooden structure from sub-floor moisture, preventing warping and ensuring long-term stability.',
  },
  {
    title: 'Support Base',
    subtitle: 'Structural sleepers · Stability',
    description: 'Treated structural sleepers provide the foundational support, ensuring uniform resiliency and levelness across the entire arena floor.',
  },
];

const metrics = [
  { label: 'Shock Absorption', value: 'KA 53%', desc: 'Excellent energy return and body protection.', icon: ShieldCheck },
  { label: 'Ball Rebound', value: 'BR 96%', desc: 'Near-perfect vertical ball bounce consistency.', icon: Activity },
  { label: 'Certification', value: 'FIBA Level 1', desc: 'Certified for international competition.', icon: Award },
  { label: 'Durability', value: '25+ Years', desc: 'Long-lasting surface with proper maintenance.', icon: Droplets },
];
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
              Premium hardwood sports flooring systems designed for basketball, badminton, and multi-purpose arenas. Engineered for professional competition and maximum athlete safety.
            </p>
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our wooden flooring systems feature complex sub-floor engineering to ensure consistent bounce and uniform resiliency.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 bg-gray-50 border border-gray-200 rounded-[2rem] p-8 md:p-12 shadow-inner group flex items-center justify-center">
               <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm">Finest Canadian Maple for professional arenas.</p>
               </div>
            </div>
          </div>
        </div>
