...
const layers = [
    {
        ...
        description:
            "The final two layers provide the court's vibrant color and specific texture. Our UV-stable pigments ensure the court remains bright even under intense sunlight.",
    },
    {
        title: "Texture Layer",
        subtitle: "Acrylic filler · Pace control",
        description:
            "Specialized acrylic filler layers determine the ITF pace rating (Slow, Medium, or Fast). This ensures a consistent ball bounce and predictable play.",
    },
    {
        title: "Cushion Layers",
        subtitle: "Liquid rubber particles · 3-5 Layers",
        description:
            "Multiple layers of liquid rubber cushion provide significant impact absorption, reducing joint strain and athlete fatigue without compromising ball speed.",
    },
    {
        title: "Resurfacer & Primer",
        subtitle: "Acrylic binder · Surface leveling",
        description:
            "A dedicated resurfacer layer seals the asphalt or concrete base and provides a perfectly level foundation for the subsequent color and cushion coats.",
    },
];
...
const metrics = [
    {
        label: "System Type",
        value: "8-Layer",
        desc: "Comprehensive multi-layered cushioning system.",
        icon: Activity,
    },
    {
        label: "UV Stability",
        value: "100%",
        desc: "Fade-resistant pigments for long-term aesthetics.",
        icon: Droplets,
    },
    {
        label: "ITF Pace",
        value: "Category 2-4",
        desc: "Options for medium-slow to medium-fast play.",
        icon: ArrowRight,
    },
    {
        label: "Shock Absorption",
        value: "Advanced",
        desc: "Cushioned layers for maximum player safety.",
        icon: ShieldCheck,
    },
];
                ...
                >
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
                            Professional acrylic surfacing for tennis,
                            basketball, and multi-sport courts. ITF-certified
                            systems designed for durability, consistent
                            performance, and vibrant aesthetics.
                        </p>
                ...
                >
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Our acrylic systems are applied in multiple layers
                            to ensure a perfectly level surface with the exact
                            pace and cushion required.
                        </p>
                    </div>
                        ...
                        <div className="lg:col-span-5 bg-gray-50 border border-gray-200 rounded-4xl p-8 md:p-12 shadow-inner group flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-gray-500 text-sm">
                                    Meeting ITF pace classifications for
