...
const stats = [
    ...
    },
    {
        ...
        number: "7",
        label: "Worldwide",
        sub: "FIFA Preferred Producers",
    },
    {
        icon: Award,
        number: "#1",
        label: "In Asia",
        sub: "Only FIFA Preferred Producer",
    },
];
...
const metrics = [
    {
        label: "Ball Roll",
        value: "4–8 m",
        desc: "Optimal ball roll ensures the game flows naturally.",
        icon: Activity,
    },
    {
        label: "Vertical Rebound",
        value: "0.6–0.85",
        desc: "Consistent, predictable bounce behaviour.",
        icon: ArrowRight,
    },
    {
        label: "Shock Absorption",
        value: "60–70%",
        desc: "Reduces leg and ligament strain significantly.",
        icon: ShieldCheck,
    },
    {
        label: "Skin Friction",
        value: "0.35–0.75",
        desc: "Allows slide tackles without dangerous abrasion.",
        icon: Droplets,
    },
];
                ...
                >
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
                            The global leader in artificial football turf,
                            offering rigorous, FIFA-certified systems that
                            provide elite performance and safety all year round.
                        </p>
                ...
                >
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Our FIFA-certified turf system is meticulously
                            engineered to ensure maximum safety, consistent
                            drainage, and peak performance.
                        </p>
                    </div>
            ...
            <section className="py-20 bg-white border-y border-gray-200 px-6 md:px-12 lg:px-24">
                ...
                >
                    ...
                    <p className="text-gray-600 max-w-2xl mx-auto mb-12">
                        Our high-performance artificial grass is regularly used
                        in FIFA's own youth world cups and international
                        tournaments.
                    </p>
                    <div className="flex flex-wrap justify-center gap-4">
                        {clubs.map((club, i) => (
                            <div
                                key={i}
                                className="bg-gray-50 border border-gray-200 rounded-full px-6 py-3 font-semibold text-gray-700"
                            >
                                {club}
                            </div>
                        ))}
