...
const stats = [
  { icon: Factory, number: '100+', label: 'Courts Installed', sub: 'Last 2 years' },
  { icon: Globe, number: '15+', label: 'Countries', sub: 'Global footprint' },
  { icon: ShieldCheck, number: 'BWF', label: 'Approved', sub: 'Certified surfaces' },
  { icon: Award, number: '#1', label: 'Choice', sub: 'For professional clubs' },
];
...
const layers = [
  {
    ...
    description: 'The top layer provides the perfect balance of grip and slide, essential for quick lateral movements. Embossed for anti-glare performance under stadium lights.',
  },
  {
    title: 'Reinforcement Layer',
    subtitle: 'Fiberglass mesh · Stability',
    description: 'A high-strength fiberglass mesh prevents the surface from stretching or shrinking, ensuring a perfectly flat and stable court throughout its life.',
  },
  {
    title: 'Buffer Layer',
    subtitle: 'Closed-cell PVC foam · Shock absorption',
    description: 'High-density foam backing provides exceptional shock absorption, protecting players\' joints and reducing fatigue during high-intensity rallies.',
  },
  {
    title: 'Base Grip',
    subtitle: 'Anti-slip backing · Firm attachment',
    description: 'The specialized bottom layer grips the sub-floor firmly, preventing any movement of the mats even during the most aggressive directional changes.',
  },
];

const metrics = [
  { label: 'Court Length', value: '13.40 m', desc: 'Standard BWF regulation length.', icon: ArrowRight },
  { label: 'Doubles Width', value: '6.10 m', desc: 'Standard BWF regulation width for doubles.', icon: Activity },
  { label: 'Shock Absorption', value: 'BWF Class 1', desc: 'Elite protection against impact injuries.', icon: ShieldCheck },
  { label: 'Surface Friction', value: '0.45 - 0.60', desc: 'Optimal grip for fast-paced footwork.', icon: Droplets },
];
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
              Premium synthetic flooring solutions for badminton, designed to provide professional-grade performance, safety, and durability for both competition and training.
            </p>
      ...
      <section className="py-20 bg-white border-y border-gray-200 px-6 md:px-12 lg:px-24">
        ...
        >
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">Engineered for Performance</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our badminton surfaces are multi-layered to provide the specific technical requirements for elite-level play.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 bg-gray-50 border border-gray-200 rounded-4xl p-8 md:p-12 shadow-inner group flex items-center justify-center">
               <div className="text-center">
                  <Activity size={48} className="text-[#84cc16] mx-auto mb-4" />
                  <h3 className="text-xl font-bold mb-2">Technical Perfection</h3>
                  <p className="text-gray-500 text-sm">Meeting BWF standards for competitive play.</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-24">
        ...
        >
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900">Key Performance Indicators</h2>
          </div>
