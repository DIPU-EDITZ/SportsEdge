...
const layers = [
    {
        ...
        description:
            "The top surface features a micro-textured grid pattern that provides exceptional grip for athletes while allowing immediate water drainage.",
    },
    {
        title: "Suspended Design",
        subtitle: "Conical support posts · Air gap",
        description:
            "Hundreds of conical posts underneath create a suspended air gap, ensuring consistent shock absorption and rapid airflow for moisture evaporation.",
    },
    {
        title: "Locking System",
        subtitle: "Interlocking snap-locks · Seamless",
        description:
            "A specialized 32-latch locking system ensures a perfectly seamless connection between tiles, preventing shifting or buckling during high-intensity play.",
    },
    {
        title: "Flex Joints",
        subtitle: "Integrated expansion joints · Thermal stability",
        description:
            "Built-in leaf-spring joints allow the modular floor to expand and contract naturally with temperature changes, maintaining a flat surface in all climates.",
    },
];
...
const metrics = [
    {
        label: "Drainage Rate",
        value: "Instant",
        desc: "Perforated grid for all-weather playability.",
        icon: Droplets,
    },
    {
        label: "Shock Absorption",
        value: "30%+",
        desc: "Suspended structure protects joints from impact.",
        icon: ShieldCheck,
    },
    {
        label: "Temperature Range",
        value: "-45°C to 135°C",
        desc: "Maintains integrity in extreme weather conditions.",
        icon: Activity,
    },
    {
        label: "Load Capacity",
        value: "250+ PSI",
        desc: "High-strength material supports heavy equipment.",
        icon: ArrowRight,
    },
];
                ...
                >
                    ...
                    <div className="text-left">
                        ...
                        <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
                            The ultimate modular flooring solution for outdoor
                            and indoor multi-sport courts. Engineered for rapid
                            drainage, player safety, and extreme durability in
                ...
                >
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            Our PP tiles combine high-grade polymers with
                            advanced structural design to deliver a surface that
                            excels in both safety and longevity.
                        </p>
                    </div>
                        ...
                        <div className="lg:col-span-5 bg-gray-50 border border-gray-200 rounded-4xl p-8 md:p-12 shadow-inner group flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-gray-500 text-sm">
                                    Playable minutes after heavy rain.
                                </p>
                            </div>
                        </div>
                    </div>
