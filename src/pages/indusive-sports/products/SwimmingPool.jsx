...
import swimmingPoolImg from "../../../assets/swimming court.avif";
...
const stats = [
    ...
    { icon: Globe, number: "MAHC", label: "Compliant", sub: "Health & safety" },
    {
        icon: ShieldCheck,
        number: "VGB",
        label: "Certified",
        sub: "Suction entrapment safety",
    },
    {
        icon: Award,
        number: "15yr",
        label: "Structure",
        sub: "Structural warranty",
    },
];
...
const layers = [
    {
        ...
        subtitle: "Tile · Pebble · Quartz",
        description:
            "Premium, chemically-resistant finishes like PebbleTec or imported ceramic tiles that provide a beautiful aesthetic and long-lasting durability.",
    },
    {
        title: "Waterproof Membrane",
        subtitle: "High-grade sealant · Leak proof",
        description:
            "Advanced waterproofing layers applied to the shell to ensure a completely monolithic and leak-proof aquatic environment.",
    },
    {
        title: "Reinforced Shell",
        subtitle: "Concrete / Gunite · Strength",
        description:
            "A heavy-duty structural shell engineered to withstand immense water pressure and soil movement over decades of use.",
    },
    {
        title: "Filtration System",
        subtitle: "UV · Ozone · Regenerative Media",
        description:
            "State-of-the-art filtration and secondary disinfection systems that ensure crystal clear, healthy water for all swimmers.",
    },
];
...
const metrics = [
    {
        label: "Water Clarity",
        value: "1-5 Microns",
        desc: "Advanced filtration achieving superior water transparency.",
        icon: Droplets,
    },
    {
        label: "Disinfection",
        value: "UV + Ozone",
        desc: "Secondary systems to neutralize chlorine-resistant pathogens.",
        icon: ShieldCheck,
    },
    {
        label: "Efficiency",
        value: "Variable Flow",
        desc: "Energy-efficient pumps reducing operating costs by up to 70%.",
        icon: Waves,
    },
    {
        label: "Safety",
        value: "VGB Standard",
        desc: "Compliant with all international suction safety guidelines.",
        icon: ArrowRight,
    },
];
                ...
                >
                    ...
                    <div className="text-left">
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
                            Professional Aquatic Systems
                        </h1>
                        <p className="text-gray-600 text-lg md:text-xl mb-8 leading-relaxed">
                            Turnkey swimming pool design and construction matching international safety guidelines, featuring advanced filtration and premium finishes for resorts, clubs, and private estates.
                        </p>
            ...
            <section className="py-20 bg-white border-y border-gray-200 px-6 md:px-12 lg:px-24">
                ...
                >
                    <div className="text-center mb-16">
                        <SectionLabel>Pool Architecture</SectionLabel>
                        <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-6">
                            Mastering the Art of Water
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            From structural integrity to advanced water chemistry, our aquatic systems are designed to provide a safe, clear, and luxurious experience.
                        </p>
                    </div>
                        ...
                        <div className="lg:col-span-5 bg-gray-50 border border-gray-200 rounded-4xl p-8 md:p-12 shadow-inner group flex items-center justify-center">
                            <div className="text-center">
                                ...
                                <p className="text-gray-500 text-sm">
                                    Advanced filtration systems that achieve drinking-water standard clarity.
                                </p>
                            </div>
                        </div>
                    </div>
