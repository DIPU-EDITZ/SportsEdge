...
const partners = [
    {
        ...
        description:
            "Our primary partner for premium synthetic turf manufacturing, providing FIFA and FIH certified solutions.",
    ...
    },
    {
        name: "EPU Floor",
        description:
            "Leading European manufacturer of polyurethane sports flooring systems for indoor and outdoor applications.",
    ...
    },
    {
        name: "Redexim",
        description:
            "Dutch specialists in advanced turf maintenance machinery, ensuring your surface stays in peak condition.",
    ...
    },
    {
        name: "Trocellen",
        description:
            "Pioneers in high-performance cross-linked polyethylene foam underlayments for superior shock absorption.",
    ...
    },
    {
        name: "Conica",
        description:
            "Swiss precision in polyurethane athletic tracks and sports surface systems globally.",
            ...
            <section className="bg-gray-50 border-b border-gray-200 pt-32 pb-16 md:pt-40 md:pb-24 px-6 md:px-12 lg:px-24">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-gray-600 text-lg md:text-xl leading-relaxed">
                        We collaborate with the world's leading manufacturers to
                        bring international standard materials and technology to
            ...
            <section className="py-20 px-6 md:px-12 lg:px-24">
                <div className="max-w-5xl mx-auto flex flex-col gap-8">
                    {partners.map((partner, idx) => (
                        <div
                            key={idx}
                            className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center justify-between hover:shadow-md transition-shadow duration-300"
                        >
                            <div className="grow">
