...
function StatCounter({ target, suffix = "+", label }) {
    ...
    return (
        <div ref={ref} className="text-center px-4">
            <div
                className="text-4xl sm:text-5xl md:text-6xl font-black text-[#84cc16]"
                style={{ fontVariantNumeric: "tabular-nums" }}
            >
                {count}
                {suffix}
            </div>
            <div className="text-gray-500 text-xs md:text-sm mt-3 font-semibold uppercase tracking-wider">
                {label}
            </div>
        </div>
    );
        ...
        <div className="flex flex-col bg-white text-gray-900 font-sans">
          ...
          ───────────────────────────────────── */}
            <div className="relative w-full overflow-hidden bg-[#08060d] h-auto lg:h-200">
                <div className="absolute top-0 left-0 w-full h-[100vh] md:h-full z-0">
                    <img 
                        src="/background.png" 
                        alt="Background" 
                        ...
                        fetchPriority="high"
                    />
                    {/* Fade bottom to remove sudden ending on mobile */}
                    <div className="absolute bottom-0 left-0 w-full h-40 bg-gradient-to-t from-[#08060d] to-transparent md:hidden" />
                </div>
          ...
          ───────────────────────────────────── */}
            <section
                id="about"
                className="py-20 md:py-28 px-6 md:px-12 lg:px-24 bg-gray-50 border-t border-gray-200"
            >
                <div
                    ref={aboutRef}
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-5">
                            SPORTS-EDGE provides innovative sports surface
                            systems which reduce leg, ligament and lower back
                            strains and injuries. Based in Kolkata, India, we
                            provide international standard surfaces for sports
                            such as Cricket, Football, Tennis, Badminton,
                            Pickleball, Volleyball, Basketball, Squash and many
                            more.
                        </p>
                        <p className="text-gray-600 text-base md:text-lg leading-relaxed mb-8">
                            We strive for superior customer satisfaction by
                            recommending the most suitable surface as per client
                            needs. We are seen as a knowledgeable solution
                            provider for sports infrastructure in the sports
                            industry — known for providing ground-breaking
                            products combined with flawless execution.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-3">
                            {["Quality", "Longevity", "Low Maintenance"].map(
                                (tag) => (
                                    <div
                                        key={tag}
          ...
          ───────────────────────────────────── */}
            <section
                id="infrastructure"
                className="py-20 md:py-28 px-6 md:px-12 lg:px-24 bg-white"
            >
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            From synthetic turfs to acrylic courts, running
                            tracks to swimming pools — we build it all.
                        </p>
                    </div>
                        ...
                        {sports.map((sport) => (
                            ...
                            >
                                ...
                                <div className="absolute top-4 right-4 bg-white p-3 rounded-full shadow-lg opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                                    <ArrowRight
                                        size={18}
                                        className="text-gray-900 stroke-[2.5]"
                                    />
                                </div>
                            </Link>
                        ))}
            ...
            >
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            From concept to completion and beyond — we handle
                            every phase of your sports facility project.
                        </p>
                    </div>
          ...
          ───────────────────────────────────── */}
            <section
                id="partners"
                className="py-20 md:py-28 px-6 md:px-12 lg:px-24 bg-gray-50 border-y border-gray-200"
            >
                <div className="max-w-7xl mx-auto">
                    {/* Section Header */}
                    <div
                    ...
                    >
                        ...
                        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                            We partner with world-leading manufacturers to bring
                            you the best in sports infrastructure.
                        </p>
                    </div>
            ...
            <section className="py-20 md:py-28 px-6 md:px-12 lg:px-24 bg-[#84cc16]">
                ...
                >
                    ...
                    <p className="text-[#08060d]/80 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed mb-10">
                        ...
                        maintenance — let's create something extraordinary
                        together.
                    </p>
