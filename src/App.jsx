...
function App() {
    return (
        <div className="relative min-h-screen bg-white text-gray-900 font-sans overflow-x-hidden antialiased">
            ...
            {/* Maintenance Layout (Commented Out)
            <div className="relative min-h-screen w-full bg-gray-50 text-gray-900 font-sans overflow-y-auto overflow-x-hidden flex flex-col justify-center items-center px-6 py-12">
                <div className="relative z-10 max-w-xl w-full flex flex-col items-center text-center px-4">
                    <div className="flex flex-col items-center mb-8">
                        <img src="/logo2.png" alt="SportsEdge Logo" className="h-16 md:h-20 w-auto object-contain" />
                        <span className="text-[#84cc16] text-xs md:text-sm font-bold mt-3 lowercase tracking-widest">
                            build with us
                        </span>
                    </div>
